...
//	    		
        ...
        function setDefaultEvents() {
        	...
        	$timeout(function(){
            	tau.helper.DrawerMoreStyle.create(document.querySelector('#moreoptionsDrawer'), {
                    handler: '.drawer-handler'
                });
            	
            	document.querySelector("#selector").addEventListener("click", function(event) {
            		var target = event.target,
    	    			drawerComponent = tau.widget.Drawer(document.querySelector("#moreoptionsDrawer"));
            ...
            document.addEventListener('rotarydetent', function (event) {
                ...
                if (direction == 'CW') {
                    angular.element(".ui-scroller").scrollTopAnimated(angular.element(".ui-scroller").scrollTop() + 100, 75);
